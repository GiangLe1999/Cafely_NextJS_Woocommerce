      ...
      <div className="grid w-full grid-cols-1 lg:grid-cols-[380px_auto] lg:gap-x-14 lg:gap-y-8 xl:gap-x-36">
        ...
        <div className="flex flex-col gap-x-1 md:grid md:grid-cols-3">
          ...
          <div className="flex-auto pt-5 mt-5 border-t border-t-app-lavender/50 lg:mt-0 lg:border-t-0 lg:pt-0">
            ...
            >
              <li>
                <Link className={footerLinkClassnames} href="/collections/all">
                  Shop All
                </Link>
              </li>
              <li>
          ...
          <div className="flex-auto pt-5 mt-5 border-t border-t-app-lavender/50 lg:mt-0 lg:border-t-0 lg:pt-0">
            ...
            >
              <li>
                <Link className={footerLinkClassnames} href="/pages/about-us">
                  Our Story
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link className={footerLinkClassnames} href="/pages/wholesale">
                  Wholesale Program
                </Link>
              </li>
              <li>
                <Link className={footerLinkClassnames} href="/pages/contact">
                  Contact
                </Link>
              </li>
            </ul>
